...
public class TransactionChannelService {
    ...
    public TransactionChannel create(TransactionChannelDTO transactionChannelDTO) {
        if (transactionChannelDTO.getName() == null) {
            throw new NullPointerException();
        }
        
        return this.repository.save(transactionChannelDTO.transformDTOToTransactionChannel());
    }
